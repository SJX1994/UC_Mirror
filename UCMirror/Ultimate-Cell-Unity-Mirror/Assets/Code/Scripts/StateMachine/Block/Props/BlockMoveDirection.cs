...
public class BlockMoveDirection : MonoBehaviour,IBlockProp
{
    ...
    private KeyValuePair<BlockMoveDirection,TetriMoveDirection> blockPairTetri = new();
    public KeyValuePair<BlockMoveDirection,TetriMoveDirection> BlockPairTetri
    {
        get
        {
        ...
        {
            if(!blockPropsState)blockPropsState = GetComponent<BlockPropsState>();
            blockPropsState.propsState = PropsData.PropsState.MoveDirectionChanger;
