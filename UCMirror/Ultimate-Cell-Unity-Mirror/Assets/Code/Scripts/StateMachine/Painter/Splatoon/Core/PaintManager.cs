...
public class PaintManager : SingletonSplatoon<PaintManager>{
    ...
    public override void Awake(){
        base.Awake();
        texturePaint = Resources.Load<Shader>("TexturePainter");
        extendIslands = Resources.Load<Shader>("ExtendIslands");
