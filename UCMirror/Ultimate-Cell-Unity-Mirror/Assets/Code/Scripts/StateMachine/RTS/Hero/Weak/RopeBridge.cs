...
public class RopeBridge : MonoBehaviour
{
    ...
    private float ropeSegLen = 0.21f;
    ...
    void Start()
    {
        if(transform.parent.TryGetComponent<UnitWeak>(out UnitWeak unitWeak))
        {
            segmentLength = (int)unitWeak.unitTemplate.engageDistance*4;
        }
    ...
    private void Simulate()
    {
        ...
        Vector3 forceGravity = new Vector3(0f, 0f ,0.15f);
